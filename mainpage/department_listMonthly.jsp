...
<%
  ...
  {  
    ...
    String sql2="SELECT department FROM STAFF_DATA WHERE emp_id =" + "'" + input_user + "'";
	...
	String sql4="SELECT * FROM FORM_HEAD_OF_PSEUDOMONAS WHERE (extract(month from APPLY_TIME)=" + sdf.format(calendar.getTime()) + ") AND (";
	sql4=sql4+data_sql;
...
<center>
    <div class="span_title"><strong>所屬部門近期休假人員</strong></div>
