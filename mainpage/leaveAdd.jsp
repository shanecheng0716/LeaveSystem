...
<%
    ...
    {  
       ...
       //取得基本資料
        ...
        //表單編號
        String sql3="SELECT MAX(FORM_NO) FROM DETAILS_OF_PSEUDOMONAS";
        rs=stmt.executeQuery(sql3); 
        if(rs.next()){		
        
        	FORM_NO = rs.getString("MAX(FORM_NO)");
        
         	int a1 = Integer.parseInt(FORM_NO);//轉成數字
         	a1 = a1+1;
    			FORM_NO = String.valueOf(a1);//轉成文字    		
        }
        
        
        //假單編號
        String sql4="SELECT MAX(DETAILS_NO) FROM DETAILS_OF_PSEUDOMONAS";
        rs=stmt.executeQuery(sql4); 
        if(rs.next()){		
        
        	DETAILS_NO = rs.getString("MAX(DETAILS_NO)");
        
         	int a2 = Integer.parseInt(DETAILS_NO);//轉成數字
         	a2 = a2+1;
    		DETAILS_NO = String.valueOf(a2);//轉成文字
    ...
    catch(Exception e)
    {
     ...
     <form  method="post" action="leaveAdd_get.jsp" onsubmit="return check_select()">
    <br>
    ...
    <table class="table table-striped table-hover" cellpadding="6" style="width: 750px;" >
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <input type="date" name="leavedate1" id="leavedate1" placeholder="2016-05-18"> 
                <script>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <input type="date" name="leavedate2" id="leavedate2" placeholder="2016-05-18">
                <script>
...
-->
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea type="text" name="reason" id="reason" cols="50" rows="5" style="resize:none;"></textarea>
            </td>
        </tr>
