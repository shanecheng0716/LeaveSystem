...
<%
    ...
    {  
        ...
        String sql1="INSERT INTO DETAILS_OF_PSEUDOMONAS VALUES ('"+DETAILS_NO+"','"+FORM_NO+"',to_date('"+ date1 +"','YYYY-MM-DD HH24:MI'),to_date('"+ date2 +"','YYYY-MM-DD HH24:MI'),'"+hours2+"','"+leavekinds+"','"+reason+"',null)";        
        ResultSet rs=stmt.executeQuery(sql1);
        
        String sql2="INSERT INTO FORM_HEAD_OF_PSEUDOMONAS VALUES ('"+FORM_NO+"',to_date('"+ Today +"','YYYY-MM-DD HH24:MI'),'"+EMP_ID+"','"+EMP_NAME+"','"+agent+"','0')";
    ...
    String message="您部門的員工:"+EMP_NAME+"，新增一則假單，請前往審核";
    ...
    Email email = new HtmlEmail(); 
   	...
   	<%
   		...
   		response.setHeader("Refresh", "1; URL = leave_getleave.jsp");
    %>
