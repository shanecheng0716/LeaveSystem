...
<%
    ...
    catch(Exception e)
    {
     ...
     <form method="post" action="leave_altercofirm.jsp" onsubmit="return check_select1()">
    <br>
    ...
    <input  type="submit"  value="確認" class="btn btn-default btn-sm" onclick="javascript: getElementById('hours2').value = hours;" /></p>
